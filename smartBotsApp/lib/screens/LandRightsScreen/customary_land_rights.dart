...
class CustomaryLandRights extends StatefulWidget {
  @override
  _CustomaryLandRightsState createState() => _CustomaryLandRightsState();
}

class _CustomaryLandRightsState extends State<CustomaryLandRights> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(text: "Customary Land Rights"),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedInputVehicle(
             ...
             RoundedInputVehicle(
              hintText: "Proposed use,e.g ploughing, residential",
              onChanged: (value) {},
            ),
            RoundedInputNumber(
